...
function M.Build(deps)
    ...
    local function TriggerAmbush(character, isLongRest, forceAmbush, opts)
        ...
        local function EA_ShowCommittedFirstAmbushTutorial()
            if (not skipTutorial) and type(EA_ShowFirstAmbushTutorial) == "function" then
                ...
                do
                    ...
                    if type(tryScripted) == "function" then
                        ...
                        if ok and ran == true then
                            ...
                            EA_ShowCommittedFirstAmbushTutorial()
